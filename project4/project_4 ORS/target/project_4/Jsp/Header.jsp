...
<%@page import="in.co.rays.project4.Ctl.*"%>
...
<table width="100%" border="0">
 ...
 %></td>
		<td rowspan="2">
			<center>
				<h1 align="left">
					<img src="<%=ORSView.APP_CONTEXT%>/image/rays.png" width="350"
						height="75">
				</h1>
			</center>
		</td>
	...
	<tr>
		<td colspan="2"><a href="<%=ORSView.GET_MARKSHEET_CTL%>">GetMarksheet</b>
		</a> | <a href="<%=ORSView.MARKSHEET_MERIT_LIST_CTL%>">Marksheet MeritList</b>
