<%@page import="in.co.rays.project4.Ctl.SubjectCtl" %>
...
<%@include file="Header.jsp" %>
 ...
 <tr>
   ...
   <td><textarea name="description"  placeholder="Enter Description" style="width: 310px;height:25px; resize: none;"><%=DataUtility.getStringData(bean.getDescription())%></textarea></td>
  <td style="position: fixed;"><font color="red"><%=ServletUtility.getErrorMessage("description",request) %></font></td>
	...
	<tr>
       ...
       <th></th> 
       <td colspan="2" align="center"> <input type="submit" style="width: 80px; height: 30px" name="operation" value="<%=SubjectCtl.OP_UPDATE%>" style="padding: 5px;">
						&emsp;
      <%--  &emsp;<input type="submit" name="operation" value="<%=SubjectCtl.OP_DELETE%>" style="padding: 5px;">&emsp; --%>
       &emsp; <input type="submit" style="width: 80px; height: 30px" name="operation" value="<%=SubjectCtl.OP_CANCEL%>" style="padding: 5px;"></td>
       </tr>
       ...
       <tr> <br><td colspan="2" align="center">&emsp;&emsp;&emsp;&emsp;&emsp;
       <input type="submit" style="width: 80px; height: 30px" name="operation" style="padding: 5px;" value="<%=SubjectCtl.OP_SAVE%>" >&emsp;&emsp;
       <input type="submit" style="width: 80px; height: 30px" name="operation" style="padding: 5px;" value="<%=SubjectCtl.OP_RESET%>" >
       </td>
       </tr>
       <% } %>
