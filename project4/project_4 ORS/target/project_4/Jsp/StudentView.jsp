...
<%@page import="in.co.rays.project4.Ctl.StudentCtl" %>
	...
	<body>
		...
		<table>
			<tr>
			  ...
			  <td><font color="red"><%=ServletUtility.getErrorMessage("firstName",request) %></font>
			  </td></tr>
			  <tr>
			  ...
			  <td><font color="red"><%=ServletUtility.getErrorMessage("lastName",request) %></font>
			  </td></tr>
			  <tr>
			  ...
			  <td><font color="red"><%=ServletUtility.getErrorMessage("email",request) %></font>
			  </td></tr>
			  ...
			  <td><font color="red"><%=ServletUtility.getErrorMessage("mobileNo",request) %></font>
			  </td></tr>
			 <tr>
			  ...
			  <tr>
			    ...
			    <td><font color="red"><%=ServletUtility.getErrorMessage("dob", request) %></font></td></tr>
