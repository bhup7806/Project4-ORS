...
<%@page import="in.co.rays.project4.Ctl.UserListCtl" %>
...
<%-- <jsp:useBean id="bean1" class="in.co.rays.project4.bean.UserBean"
...
<tr>
  ...
  <th>Edit</th>
    ...
    <%System.out.println("userBean on jsp.................------"+bean.getLastName()); %>
	...
	rbean1 = rmodel.findByPK(bean.getRoleId());
    
    %>
    <td align="center"><%=rbean1.getName()%></td>
