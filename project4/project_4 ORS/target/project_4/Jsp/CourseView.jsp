<%@page import="in.co.rays.project4.Ctl.CourseCtl"  %>
...
<%@include file="Header.jsp" %>
	...
	<tr>
		...
		<td><textarea name="description"   placeholder="Enter Description" style="width: 310px;height:22px; resize: none;"><%=DataUtility.getStringData(bean.getDescription())%></textarea></td>
