<%@page import="in.co.rays.project4.Ctl.TimeTableCtl"%>
...
<body>
	<form action="<%=ORSView.TIMETABLE_CTL%>" method="POST">
		...
		<jsp:useBean id="bean" class="in.co.rays.project4.bean.TimeTableBean"
		...
		<input type="hidden" name="modifiedDatetime" value="<%=DataUtility.getTimestamp(bean.getModifiedDatetime())%>">
			...
			<table>
				<tr>
					...
					<td><%=HTMLUtility.getList("courseName", String.valueOf(bean.getCourseName()), clist)%>
				...
				<tr>
					...
					<td><%=HTMLUtility.getList("subName", String.valueOf(bean.getSubName()), slist)%>

					</td>
					<td style="position: fixed;"><font color="red"> <%=ServletUtility.getErrorMessage("subName", request)%></font></td>
				...
				<tr>
					...
					<td><textarea name="description" placeholder="enter Description" style="width: 310px;height:18px; resize: none;">
				...
				<tr>
					<th></th>
					<td colspan="2" align="center"><input type="submit" style="width: 80px; height: 30px"
						name="operation" style="padding: 5px;"
						value="<%=TimeTableCtl.OP_UPDATE%>">&emsp; <input
						style="padding: 5px;" type="submit" name="operation" style="width: 80px; height: 30px"
				...
				<tr>
					...
					<td colspan="2" align="center"><input type="submit" style="width: 80px; height: 30px"
						...
						value="<%=TimeTableCtl.OP_SAVE%>">&emsp;
						 ...
						 <input
						type="submit" style="width: 80px; height: 30px" name="operation" value="<%=TimeTableCtl.OP_RESET%>"
