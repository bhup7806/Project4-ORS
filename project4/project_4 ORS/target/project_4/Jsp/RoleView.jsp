<%@page import="in.co.rays.project4.Ctl.RoleCtl" %>
<%@page import="in.co.rays.project4.Ctl.BaseCtl" %>
...
<tr>
	<th ></th>
	<td colspan="2"  >&emsp;&emsp;<input type="submit" style="width: 80px; height: 30px" name="operation" value="<%=RoleCtl.OP_UPDATE%>">&emsp;&emsp;&emsp;
	<input type="submit" style="width: 80px; height: 30px" name="operation" value="<%=RoleCtl.OP_CANCEL%>"></td>
	</tr>
		<%
				}else{
		%>
		<th ></th>
	<td colspan="2">&emsp;&emsp;<input type="submit" style="width: 80px; height: 30px" name="operation" value="<%=RoleCtl.OP_SAVE%>">&emsp;&emsp;&emsp;
	<input type="submit" style="width: 80px; height: 30px" name="operation" value="<%=RoleCtl.OP_RESET%>"></td>
	</tr>
