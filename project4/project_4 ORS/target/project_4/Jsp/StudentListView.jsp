<%@page import="in.co.rays.project4.Ctl.StudentListCtl" %>
...
<body>
	...
	<tr>
		<td align="center">
		<label class="p1"> FirstName :</label> <input type="text" name="firstName" placeholder="Entre First Name" 
		class="p2"value="<%=ServletUtility.getParameter("firstName", request)%>">&emsp;&emsp;
		
		
		<label class="p1">Email_Id :</label> <input type="text" name="email" placeholder="Entre Email_ID"class="p2"
