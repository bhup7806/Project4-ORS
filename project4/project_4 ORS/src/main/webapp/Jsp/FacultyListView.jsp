...
<%@page import="in.co.rays.project4.Ctl.FacultyListCtl"%>
...
<form action="<%=ORSView.FACULTY_LIST_CTL%>" method="POST">
		<h1 style="font-size: 35px;">Faculty List</h1>
		...
		<table>
				<tr>
					<td><label class="p1">First Name</label>&emsp;
					<input type="text"
						name="firstName" placeholder="Entre First Name"  class="p2" size="25"
		...
		<%=HTMLUtility.getList("courseId", String.valueOf(bean.getCourseId()), list2)%>&emsp;
