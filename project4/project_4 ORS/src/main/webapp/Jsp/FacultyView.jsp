<%@page import="in.co.rays.project4.Ctl.FacultyCtl"%>
			  ...
			  <td><input type="text" name="firstName" class="p2" size="40"
				...
				<tr>
					<th align="left" class="p1">College Name<span
						style="color: red;">*</span></th>
					<td><%=HTMLUtility.getList("collegeId", String.valueOf(bean.getCollegeId()), li)%>
					</td>
				...
				<tr>
					<th align="left" class="p1">Course Name<span
						style="color: red;">*</span></th>
					<td><%=HTMLUtility.getList("courseId", String.valueOf(bean.getCourseId()), lis)%></td>
				...
				<tr>
					<th align="left" class="p1">Subject Name<span
						style="color: red;">*</span></th>
					<td><%=HTMLUtility.getList("subjectId", String.valueOf(bean.getSubjectId()), list)%></td>
				...
				<tr>
					<td></td>
					<td colspan="1" align="center"><input type="submit" style="width: 80px; height: 30px"
						name="operation" style="padding: 5px;"
						value="<%=FacultyCtl.OP_UPDATE%>"> &emsp;<input
						type="submit" style="width: 80px; height: 30px" name="operation" style="padding: 5px;"
				...
				<tr>
					...
					<td colspan="1" align="center"><input type="submit" style="width: 80px; height: 30px"
						...
						style="padding: 5px;"> &emsp;<input type="submit" style="width: 80px; height: 30px"
