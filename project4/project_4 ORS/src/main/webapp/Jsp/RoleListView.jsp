<%@page import="in.co.rays.project4.Ctl.RoleListCtl"%>
...
<body>
	...
	<center>
		...
		<form action="<%=ORSView.ROLE_LIST_CTL%>" method="post">
			...
			<%
				List list1 = (List) request.getAttribute("role");
			%>
			<%
			...
			<table width="100%">
				<tr>
					<td align="center"><label>Name</label> <%=HTMLUtility.getList("role", String.valueOf(bean.getId()), list1)%>


						&nbsp; <input type="submit" name="operation"
						value="<%=RoleListCtl.OP_SEARCH%>" style="padding: 5px;">&nbsp;
						<input type="submit" name="operation"
						value="<%=RoleListCtl.OP_RESET%>" style="padding: 5px;"></td>
