...
import in.co.rays.project4.Ctl.BaseCtl;
import in.co.rays.project4.Ctl.ORSView;
import in.co.rays.project4.bean.BaseBean;
import in.co.rays.project4.model.UserModel;

/**
 * This class provides utility operation for Servlet container like forward, redirect, handle generic exception,
            manage success and error message
 * @author bhupendra
 *
 */
public class ServletUtility {
    ...
    public static int getPageSize(HttpServletRequest request) {
        ...
        //DataUtility.getInt((String)request.getAttribute("pageSize"));
