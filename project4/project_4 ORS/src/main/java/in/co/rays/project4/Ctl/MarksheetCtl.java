...
protected boolean validate(HttpServletRequest request)  {
	...
	}if(DataValidator.isNull(request.getParameter("student"))){
		request.setAttribute("student",PropertyReader.getValue("error.require","Student Name"));
		pass=false;
...
protected BaseBean populateBean(HttpServletRequest request) {
	...
	bean.setStudentId(DataUtility.getLong(request.getParameter("student")));
